...
<form method="post" action="{{url($resume->slug.'/update')}}">
        @csrf @method('put')
<a href="javascript:history.back()" class="md:p-7 p-2 text-xs text-gray-500"><i class="fa fa-arrow-left">&nbsp;&nbsp;</i>Back to Dashboard</a>
    ...
    <div class="mt-8 p-4">
        ...
        <div class="flex flex-col md:flex-row">
                <div class="w-full mx-2 flex-1">
                    ...
                    <div class="bg-white my-2 p-1 flex border border-gray-200 rounded">
                        <input id="first_name" name="first_name" value="{{$resume->first_name}}" placeholder="Your first name" class="p-1 px-2 appearance-none outline-none w-full text-gray-800"> </div>
                </div>
                <div class="w-full mx-2 flex-1">
                    <div class="font-bold h-6 mt-3 text-gray-600 text-xs leading-8 uppercase"> Last Name</div>
                    <div class="bg-white my-2 p-1 flex border border-gray-200 rounded">
                        <input id="last_name" name="last_name" value="{{$resume->last_name}}" placeholder="Your last name" class="p-1 px-2 appearance-none outline-none w-full text-gray-800"> </div>
                </div>
                <div class="w-full mx-2 flex-1">
                    <div class="font-bold h-6 mt-3 text-gray-600 text-xs leading-8 uppercase"> Profile Title</div>
                    <div class="bg-white my-2 p-1 flex border border-gray-200 rounded">
                        <input id="title" name="title" value="{{$resume->title}}" placeholder="Senior Data Analyst" class="p-1 px-2 appearance-none outline-none w-full text-gray-800"> </div>
                </div>
            </div>
            <div class="flex flex-col md:flex-row">
                <div class="w-full mx-2 flex-1">
                    ...
                    <div class="bg-white my-2 p-1 flex border border-gray-200 rounded">
                    <textarea class="w-full p-2"  name="summary" rows="4" cols="60" placeholder="Describe your profile here...">{{$resume->summary}}</textarea>
                </div>
            </div>
      </div>
        ...
        border-gray-600 transition">Previous</button> -->
            <div class="flex-auto flex flex-row-reverse">
                <a class="btn btn-next text-sm  ml-4 hover:scale-110 focus:outline-none flex justify-center px-2 py-1 rounded font-bold cursor-pointer 
        hover:bg-slate-600  
        bg-slate-600 
        text-slate-100 
        border duration-200 ease-in-out 
        ...
        <div class="flex flex-col md:flex-row">
                <div class="w-full mx-2 flex-1">
                    ...
                    <div class="bg-white my-2 p-1 flex border border-gray-200 rounded">
                        <input id="email" name="email" value="{{$resume->email}}" placeholder="john.appleseed@example.com" class="p-1 px-2 appearance-none outline-none w-full text-gray-800"> </div>
                </div>
                <div class="w-full mx-2 flex-1">
                    <div class="font-bold h-6 mt-3 text-gray-600 text-xs leading-8 uppercase"> Phone Number</div>
                    <div class="bg-white my-2 p-1 flex border border-gray-200 rounded">
                        <input id="phone" name="phone" value="{{$resume->phone_no}}" placeholder="(+60) 11-11xx-xxxx" class="p-1 px-2 appearance-none outline-none w-full text-gray-800"> </div>
                </div>
            </div>
            <div class="flex flex-col md:flex-row">
                <div class="w-full mx-2 flex-1">
                    ...
                    <div class="bg-white my-2 p-1 flex border border-gray-200 rounded">
                        <input id="linkedin_url" name="linkedin_url" value="{{$resume->linkedin_url}}" placeholder="www.linkedin.com/in/johnxxxxx" class="p-1 px-2 appearance-none outline-none w-full text-gray-800"> </div>
                </div>
                <div class="w-full mx-2 flex-1">
                    <div class="font-bold h-6 mt-3 text-gray-600 text-xs leading-8 uppercase"> Location</div>
                    <div class="bg-white my-2 p-1 flex border border-gray-200 rounded">
                        <input id="location" name="location" value="{{$resume->location}}" placeholder="Kuala Lumpur, Malaysia" class="p-1 px-2 appearance-none outline-none w-full text-gray-800">
                </div>
            </div>
      </div>
      ...
      <div class="form-step">
        ...
        @php
            $sortedEducations = $resume->educations->sortByDesc('start_date');
        @endphp
        ...
        <div class="flex flex-col md:flex-row">
                <div class="w-full mx-2 flex-1">
                    ...
                    <div class="bg-white my-2 p-1 flex border border-gray-200 rounded">
                        <input id="school_name" name="school_name[]" value="{{$education->school_name}}" placeholder="Enter your institution name here." class="p-1 px-2 appearance-none outline-none w-full text-gray-800"> </div>
                </div>
                <div class="w-full mx-2 flex-1">
                    <div class="font-bold h-6 mt-3 text-gray-600 text-xs leading-8 uppercase"> Institution Location</div>
                    <div class="bg-white my-2 p-1 flex border border-gray-200 rounded">
                        <input id="school_location" name="school_location[]" value="{{$education->school_location}}" placeholder="Kuala Lumpur, Malaysia" class="p-1 px-2 appearance-none outline-none w-full text-gray-800"> </div>
                </div>
                <div class="w-full mx-2 flex-1">
                    <div class="font-bold h-6 mt-3 text-gray-600 text-xs leading-8 uppercase"> Degree</div>
                    <div class="bg-white my-2 p-1 flex border border-gray-200 rounded">
                        <input id="degree" name="degree[]" placeholder="BSc(Hons) in Computer Science" value="{{$education->degree}}" class="p-1 px-2 appearance-none outline-none w-full text-gray-800"> </div>
                </div>
            </div>
            <div class="flex flex-col md:flex-row">
                <div class="w-full mx-2 flex-1">
                    ...
                    <div class="bg-white my-2 p-1 flex border border-gray-200 rounded">
                        <input id="start_date" name="start_date[]" type="date"  value="{{ $education->start_date }}" class="p-1 px-2 appearance-none outline-none w-full text-gray-800"> </div>
                </div>
                <div class="w-full mx-2 flex-1">
                    <div class="font-bold h-6 mt-3 text-gray-600 text-xs leading-8 uppercase"> End Period</div>
                    <div class="bg-white my-2 p-1 flex border border-gray-200 rounded">
                        <input id="end_date" name="end_date[]" type="date" min="" value="{{ $education->end_date }}" class="p-1 px-2 appearance-none outline-none w-full text-gray-800">
                </div>
            </div>
          </div>
          <div class="flex p-2 mt-4">
            <div class="flex-auto flex flex-row-reverse">
                <a class="remove-btn text-sm ml-2 hover:scale-110 focus:outline-none flex justify-center px-2 py-1 rounded font-bold cursor-pointer 
        hover:bg-rose-700  
        bg-rose-600 
        text-rose-100 
        border duration-200 ease-in-out 
      ...
      @php
            $sortedExperiences = $resume->experiences->sortByDesc('start_date');
        @endphp
      @foreach ($sortedExperiences as $experiences)
      <hr class="my-4 border-2">
        ...
        <div class="flex flex-col md:flex-row">
                <div class="w-full mx-2 flex-1">
                    ...
                    <div class="bg-white my-2 p-1 flex border border-gray-200 rounded">
                        <input id="company_name" name="company_name[]" value="{{$experiences->company_name}}" placeholder="Enter your company name here." class="p-1 px-2 appearance-none outline-none w-full text-gray-800"> </div>
                </div>
                <div class="w-full mx-2 flex-1">
                    <div class="font-bold h-6 mt-3 text-gray-600 text-xs leading-8 uppercase"> Company Location</div>
                    <div class="bg-white my-2 p-1 flex border border-gray-200 rounded">
                        <input id="company_location" name="company_location[]" value="{{$experiences->company_location}}" placeholder="Kuala Lumpur, Malaysia" class="p-1 px-2 appearance-none outline-none w-full text-gray-800"> </div>
                </div>
                <div class="w-full mx-2 flex-1">
                    <div class="font-bold h-6 mt-3 text-gray-600 text-xs leading-8 uppercase"> Job Title</div>
                    <div class="bg-white my-2 p-1 flex border border-gray-200 rounded">
                        <input id="job_title" name="job_title[]" value="{{$experiences->job_title}}" placeholder="IT Internship" class="p-1 px-2 appearance-none outline-none w-full text-gray-800"> </div>
                </div>
            </div>
            <div class="flex flex-col md:flex-row">
                <div class="w-full mx-2 flex-1">
                    <div class="font-bold h-6 mt-3 text-gray-600 text-xs leading-8 uppercase"> Start Period</div>
                    <div class="bg-white my-2 p-1 flex border border-gray-200 rounded">
                        <input id="work_start_date" name="work_start_date[]" type="date"  value="{{ $experiences->start_date }}" class="p-1 px-2 appearance-none outline-none w-full text-gray-800"> </div>
                </div>
                <div class="w-full mx-2 flex-1">
                    <div class="font-bold h-6 mt-3 text-gray-600 text-xs leading-8 uppercase"> End Period</div>
                    <div class="bg-white my-2 p-1 flex border border-gray-200 rounded">
                        <input id="work_end_date" name="work_end_date[]" type="date" min=""  value="{{ $experiences->end_date }}" class="p-1 px-2 appearance-none outline-none w-full text-gray-800"></div>
                </div>
            </div>
            <div class="flex flex-col md:flex-row">
                <div class="w-full mx-2 flex-1">
                    ...
                    <div class="bg-white my-2 p-1 flex border border-gray-200 rounded">
                    <textarea id="work_description" name="work_description[]" class="w-full p-2" rows="4" cols="60"  placeholder="Describe what you are doing there...">{{$experiences->description}}</textarea>
                </div>
            </div>
          </div>
          <div class="flex p-2 mt-4">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    educationContainer.addEventListener('click', function(event) {
        ...
        if (event.target.classList.contains('remove-btn') || event.target && event.target.classList.contains('remove-btn-existing')) {
        ...
        <div class="flex flex-col md:flex-row">
            ...
            <div class="flex flex-col md:flex-row">
                <div class="w-full mx-2 flex-1">
                    <div class="font-bold h-6 mt-3 text-gray-600 text-xs leading-8 uppercase"> Start Period</div>
                    <div class="bg-white my-2 p-1 flex border border-gray-200 rounded">
                        <input id="work_start_date" name="work_start_date[]" type="date" class="p-1 px-2 appearance-none outline-none w-full text-gray-800"> </div>
                </div>
                <div class="w-full mx-2 flex-1">
                    <div class="font-bold h-6 mt-3 text-gray-600 text-xs leading-8 uppercase"> End Period</div>
                    <div class="bg-white my-2 p-1 flex border border-gray-200 rounded">
                        <input id="work_end_date" name="work_end_date[]" type="date" min="" class="p-1 px-2 appearance-none outline-none w-full text-gray-800"></div>
                </div>
            </div>
            <div class="flex flex-col md:flex-row">
                <div class="w-full mx-2 flex-1">
                    <div class="font-bold h-6 mt-3 text-gray-600 text-xs leading-8 uppercase"> Description</div>
                    <div class="bg-white my-2 p-1 flex border border-gray-200 rounded">
                    <textarea id="work_description" name="work_description[]" class="w-full p-2" rows="4" cols="60"  placeholder="Describe what you are doing there..."></textarea>
                </div>
            </div>
          </div>
            <div class="flex p-2 mt-4">
